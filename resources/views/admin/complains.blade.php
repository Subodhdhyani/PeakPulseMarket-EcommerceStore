    ...
    <x-slot:dynamic_title_top>
        ...
        <x-slot:section_dynamic_content>
            ...
            <table class="table  table-striped table-bordered">
                <thead>
                    <tr>
                        <th scope="col" class="d-none d-md-table-cell">S.No</th>
                        ...
                        <th scope="col" class="d-none d-md-table-cell">Description</th>{{--Hide the Column on Small Screen--}}
                        <th scope="col" colspan="2" class="text-center">Status [Mark Check]</th>
                                ...
                                if (data.rec.length === 0) {
                                    ...
                                    data.rec.forEach(function(record) {
                                        ...
                                        var row = '<tr>' +
                                            ...
                                            '<td class="d-none d-md-table-cell">' + record.tblbooking.billing_name + '</td>' +
                                            '<td class="d-none d-md-table-cell">' + record.tblbooking.billing_phone + '</td>' +
                                            '<td>' + bookingIdLink + '</td>' + // This makes booking_id a link
                                            '<td class="d-none d-md-table-cell">' + record.subject + '</td>' +
                                            '<td class="d-none d-md-table-cell">' + record.description + '</td>' +
                                            '<td>' + checkboxHtml + '<p class="text-danger" style="display: inline;">(&check;:Inprogress)</p></td>' +
                                            '<td>' + checkboxHtml2 + '<p class="text-danger" style="display: inline;">(&check;:Resolved)</p></td>' +
                                            '</tr>';
