<x-dashboard_common>
    <x-slot:dynamic_title_top>
        ...
        <x-slot:section_dynamic_content>
            <div class="container">
                {{--Heading--}}
                <h1 class="text-center text-danger">Manage Shipped Booking</h1>
                    ...
                    function loaddata() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#fetch_booking').empty();
                                if (respo.length === 0) {
                                    $('#fetch_booking').append('<tr><td colspan="6" class ="text-center text-danger" style="font-size: 30px;">No Shipped Order found</td></tr>');
                                } else {
