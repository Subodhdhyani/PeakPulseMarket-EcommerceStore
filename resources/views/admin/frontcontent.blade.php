        ...
        <form id="submit_carousel_form" autocomplete="off">
          <fieldset>
            ...
            <div class="row mt-4 mb-4">
              ...
              <div class="col">
                <div id="firstpic_show" style="background-color: red; height:15vh; width:50%;"></div>
              </div>
            </div>
            <div class="row mt-4 mb-4">
              <div class="col">
              ...
              <div class="col">
                <div id="secondpic_show" style="background-color: red; height:15vh; width:50%;"></div>
              </div>
            </div>
            <div class="row mt-4 mb-4">
              <div class="col">
              ...
              <div class="col">
                <div id="thirdpic_show" style="background-color: red; height:15vh; width:50%;"></div>
              </div>
            </div>
            <div class="row mt-4 mb-4">
              <div class="col">
