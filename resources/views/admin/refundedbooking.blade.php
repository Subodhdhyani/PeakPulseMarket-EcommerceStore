    ...
    <x-slot:dynamic_title_top>
        ...
        <x-slot:section_dynamic_content>
            <style>
                ...
                /*Disabe Delete Refunded Booking if want to enable just remove this class*/
                .disabled-link {
                    pointer-events: none;
                    opacity: 0.5;
                }
                    ...
                    function loaddata() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#fetch_booking').empty();
                                if (respo.length === 0) {
                                    $('#fetch_booking').append('<tr><td colspan="6" class ="text-center text-danger" style="font-size: 30px;">No Refunded Order Found</td></tr>');
                                } else {
                                    respo.forEach(function(record) {
                                        $('#fetch_booking').append(
                                            ...
                                            '<td>' +
                                            '<a href="" class="refunded_booking_action text-dark disabled-link" data-id="' + record.booking_id + '" data-bs-toggle="tooltip" title="Delete Refunded Booking"><i class="bi bi-archive-fill"></i></a>&emsp;' +
