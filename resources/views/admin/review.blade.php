            ...
            <table class="table  table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col"class="d-none d-md-table-cell">User_id</th>
                        <th scope="col">Product_id</th>
                        <th scope="col">Rating</th>
                        <th scope="col" class="d-none d-md-table-cell">Review</th>{{--Hide the Column on Small Screen--}}
                            ...
                            success: function(data) {
                                ...
                                if (data.rec.length === 0) {
                                    ...
                                    data.rec.forEach(function(record) { //if object then data.send.forEach(record) or var x=data.send;
                                        ...
                                        var row = '<tr>' +
                                            '<td>' + record.id + '</td>' +
                                            '<td class="d-none d-md-table-cell">' + record.tbluser_id + '</td>' +
                                            '<td><a href="/product_checkout/' + record.tblproduct_id + '" class="product-link" target="_blanck">' + record.tblproduct_id + '</a></td>' +
                                            '<td>' + record.rating + '</td>' +
                                            '<td class="d-none d-md-table-cell">' + record.review + '</td>' +
