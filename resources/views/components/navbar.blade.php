...
<div>
  <nav class="navbar navbar-expand-lg bg-warning">
    <div class="container-fluid d-flex align-items-center">
      <a class="navbar-brand me-4" href="{{route('index')}}"><img src="{{asset('Business_Logo/logo1.png')}}" alt="Business Logo" style="height: 65px; width: 90px;"></a>

      <form class="d-none d-lg-flex flex-grow-1 me-4" role="search" id="nav_search" autocomplete="off">
      ...
      @auth('custom_web')
      <div>
        <h6 id="greetingnameatnavbar" class="text-dark"></h6>
