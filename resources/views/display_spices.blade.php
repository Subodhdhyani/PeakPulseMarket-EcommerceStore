...
<head>
    ...
    <title>Spices - PeakPulseMarket</title>
...
<body>
    ...
    <div class="dynamic-search-result-show-then-hide-this">{{--Inside navbar Component--}}
        ...
        <h2 class="text-center mt-4 mb-4" style="color: #1fdb22;">Explorer Spices <i class="fa-solid fa-angles-down fa-lg" style="color: #1fdb22;"></i></h2>
