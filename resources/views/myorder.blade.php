...
<head>
    ...
    <style>
        ...
        /* Remove underline and blue color from anchor tag of/on main container */
        a {
                                            ...
                                            <div class="row h-100">
                                               <div class="col-2 first_section">
                                                ...
                                                <div class="col-10 second_section">
                                                    ...
                                                    <h5 class="text-primary">Status on ${formattedDate}: <strong class="text-danger">${orderStatusText}</strong></h5>
                                                    <h5 class="text-primary d-none d-md-block">Payment Status: <strong class="text-danger">${order.payment_status}</strong></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
