        ...
        <div class="container mt-2 mb-2">
            ...
            <div class="row h-100">
                ...
                <div class="col-4">
                    ...
                    <a href="#" style="display: inline-block; margin-right: 120px;" id="cancel_order_click" class="hide_anchor_style text-primary">Cancel <i class="fa-regular fa-circle-left fa-bounce fa-lg"></i></a>
                    @elseif($orders->first()->status_text === 'Delivered')
                    <a href="#" style="display: inline-block; margin-right: 120px;" id="return_order_click" class="hide_anchor_style text-primary">Return <i class="fa-regular fa-circle-left fa-bounce fa-lg"></i></a>
                    @elseif($orders->first()->status_text === 'Cancelling' || $orders->first()->status_text === 'Returning')
                    <h6 class="text-danger">Order Return in Progress.Refunding soon <i class="fa-regular fa-circle-left fa-bounce fa-lg text-primary"></i></h6>
                    ...
                    @else
                    <h6 class="text-danger">You can't cancel the order once its shipped. Dont't worry you can easily return when its shipped. <i class="fa-regular fa-circle-left fa-bounce fa-lg text-primary"></i></h6>
                    @endif
                    ...
                    @else
                    <h6 class="text-danger">Invoice available after product delivered <i class="fa-solid fa-arrow-down fa-bounce fa-lg text-primary"></i></h6>
                    @endif
                </div>
                @endif
